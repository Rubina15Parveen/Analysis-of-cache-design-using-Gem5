...
sed -i "s|time.*$|time \/home/010/r/rx/rxl220014/CA/gem5/build/X86/gem5.opt -d ./m5out \/home/010/r/rx/rxl220014/CA/gem5/configs/example/se.py -c \$BENCHMARK -o \$ARGUMENT -I 500000000 --cpu-type=TimingSimpleCPU --caches --l2cache --l1d_size=${L1d} --l1i_size=${L1i} --l2_size=${L2} --l1d_assoc=${L1d_associativity} --l1i_assoc=${L1i_associativity} --l2_assoc=${L2_associativity} --cacheline_size=${Cache_size}|g" $(pwd)/Project1_SPEC/401.bzip2/runGem5.sh
...
#
sed -i "s|time.*$|time \/home/010/r/rx/rxl220014/CA/gem5/build/X86/gem5.opt -d ./m5out \/home/010/r/rx/rxl220014/CA/gem5/configs/example/se.py -c \$BENCHMARK -o '20 reference.dat 0 1 ./data/100_100_130_cf_a.of' -I 500000000 --cpu-type=TimingSimpleCPU --caches --l2cache --l1d_size=${L1d} --l1i_size=${L1i} --l2_size=${L2} --l1d_assoc=${L1d_associativity} --l1i_assoc=${L1i_associativity} --l2_assoc=${L2_associativity} --cacheline_size=${Cache_size}|g" $(pwd)/Project1_SPEC/470.lbm/runGem5.sh
...
echo -e "****** 401.bzip2\n" >> /home/010/r/rx/rxl220014/CA/branchpred.txt
cat stats.txt | grep system.cpu.branchPred.BTBMissPct >> /home/010/r/rx/rxl220014/CA/branchpred.txt
cat stats.txt | grep system.cpu.BranchMispredPercent >> /home/010/r/rx/rxl220014/CA/branchpred.txt
echo -e "\n"
...
#./project2.sh 128kB 128kB 1MB 2 2 4 64 401.bzip2 429.mcf 456.hmmer 458.sjeng 470.lbm
